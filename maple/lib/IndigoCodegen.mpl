...
IndigoCodegen := module()
  ...
  local ExtractElements := proc(
    ...
    local i, j, idx, lst, out, cur, tmp, str1, str2, tot, ndim;
  ...
  export ImplicitSystemToMatlab := proc(
    ...
    local i, bar, vars_tmp, eqns_tmp, invs_tmp, algs_tmp, vars_dot, x, x_dot, F,
      JF_x, JF_x_dot, h, Jh_x, GA, mk_algs_var, mk_algs_dot, mk_vars_dot, rm_deps,
    ...
    Jh_x     := IndigoUtils:-DoJacobian(invs_tmp, vars_tmp);
    ...
    return cat(
      ...
      "\n",
      "classdef ", name, " < Indigo_ImplicitSystem\n",
      i, "%\n",
      i, "% ", info, "\n",
      i, "%\n",
      ...
      i, i, i, "this = this@Indigo_ImplicitSystem('", name, "', num_eqns, num_invs);\n",
      `if`(nops(data) > 0, cat(
      "\n",
      i, i, i, "% User data\n",
      i, i, i, "if (nargin == 0)\n",
  ...
  export ExplicitSystemToMatlab := proc(
    ...
    local i, bar, vars_tmp, eqns_tmp, invs_tmp, algs_tmp, vars_dot, x, x_dot, A,
      b, f, Jf, h, Jh_x, GA, mk_algs_var, mk_algs_dot, mk_vars_dot, rm_deps,
      data_str, algs_fun, algs_grd, properties, tmp, tmp1, tmp2;
    ...
    return cat(
      ...
      "% DISCLAIMER: If you need to edit it, do it wisely!\n",
      "\n",
      "classdef ", name, " < Indigo_ExplicitSystem\n",
      i, "%\n",
      i, "% ", info, "\n",
      i, "%\n",
      i, "properties (SetAccess = protected, Hidden = true)\n",
      ...
      i, i, i, "num_eqns = ", LinearAlgebra:-Dimension(eqns_tmp), ";\n",
      i, i, i, "num_invs = ", LinearAlgebra:-Dimension(invs_tmp), ";\n",
      i, i, i, "this = this@Indigo_ExplicitSystem('", name, "', num_eqns, num_invs);\n",
      `if`(nops(data) > 0, cat(
      "\n",
      i, i, i, "% User data\n",
      i, i, i, "if (nargin == 0)\n",
  ...
  export SemiExplicitSystemToMatlab := proc(
    ...
    local i, bar, vars_tmp, eqns_tmp, invs_tmp, algs_tmp, vars_dot, x, x_dot, A,
      TA, b, Jb, h, Jh_x, GA, mk_algs_var, mk_algs_dot, mk_vars_dot, rm_deps,
      data_str, algs_fun, algs_grd, properties, tmp, tmp1, tmp2;
    ...
    return cat(
      ...
      "% DISCLAIMER: If you need to edit it, do it wisely!\n",
      "\n",
      "classdef ", name, " < Indigo_SemiExplicitSystem\n",
      i, "%\n",
      i, "% ", info, "\n",
      i, "%\n",
      i, "properties (SetAccess = protected, Hidden = true)\n",
      ...
      i, i, i, "this = this@Indigo_SemiExplicitSystem('", name, "', num_equations, num_invariants);\n",
      `if`(nops(data) > 0, cat(
      "\n",
      i, i, i, "% User data\n",
      i, i, i, "if (nargin == 0)\n",
