...
+4*g*m+lambda__4(t)-lambda__8(t)+lambda__12(t) = 0, -l*(-64*diff(omega__BD(t),t
...
u__fg(t),t)*m+lambda__9(t)-lambda__11(t) = 0, 2*diff(v__fg(t),t)*m+lambda__10(t
...
lambda__5(t)-lambda__13(t) = 0, 2*diff(v__CE(t),t)*m+2*g*m+lambda__6(t)-
lambda__14(t) = 0, -2*l*(-4*diff(omega__CE(t),t)*l*m+3*lambda__14(t)*cos(
theta__CE(t))-3*lambda__13(t)*sin(theta__CE(t))) = 0, 2*diff(u__ED(t),t)*m+
lambda__13(t)+lambda__7(t) = 0, 2*diff(v__ED(t),t)*m+2*g*m+lambda__8(t)+
lambda__14(t) = 0, 2*l*(4*diff(omega__ED(t),t)*l*m+3*lambda__14(t)*cos(
theta__ED(t))-3*lambda__13(t)*sin(theta__ED(t))) = 0, 2*l+x__AC(t) = 0, y__AC(t
) = 0, -2*l+x__BD(t) = 0, y__BD(t) = 0, -4*cos(theta__AC(t))*l-x__AC(t)+x__CE(t
) = 0, -4*sin(theta__AC(t))*l-y__AC(t)+y__CE(t) = 0, -4*cos(theta__BD(t))*l+
x__ED(t)-x__BD(t) = 0, -4*sin(theta__BD(t))*l+y__ED(t)-y__BD(t) = 0, -3*cos(
theta__AC(t))*l-x__AC(t)+x__fg(t) = 0, -3*sin(theta__AC(t))*l-y__AC(t)+y__fg(t)
= 0, 3*cos(theta__BD(t))*l-2*cos(theta__fg(t))*l+x__BD(t)-x__fg(t) = 0, 3*sin(
theta__BD(t))*l-2*sin(theta__fg(t))*l+y__BD(t)-y__fg(t) = 0, -2*cos(theta__CE(t
))*l+2*l*cos(theta__ED(t))+x__ED(t)-x__CE(t) = 0, 2*l*sin(theta__ED(t))-2*sin(
theta__CE(t))*l+y__ED(t)-y__CE(t) = 0];
