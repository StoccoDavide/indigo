...
), x__4(t), y__4(t), u__4(t), v__4(t), lambda__4(t), x__5(t), y__5(t), u__5(t),
v__5(t), lambda__5(t)];
...
t)^2-(ell+c*lambda__2(t))^2 = 0, diff(x__4(t),t)-u__4(t) = 0, diff(y__4(t),t)-
v__4(t) = 0, diff(u__4(t),t)+2*x__4(t)*lambda__4(t) = 0, diff(v__4(t),t)+2*y__4
(t)*lambda__4(t)+g = 0, x__4(t)^2+y__4(t)^2-(ell+c*lambda__3(t))^2 = 0, diff(
x__5(t),t)-u__5(t) = 0, diff(y__5(t),t)-v__5(t) = 0, diff(u__5(t),t)+2*x__5(t)*
lambda__5(t) = 0, diff(v__5(t),t)+2*y__5(t)*lambda__5(t)+g = 0, x__5(t)^2+y__5(
t)^2-(ell+c*lambda__4(t))^2 = 0];
