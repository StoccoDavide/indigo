...
classdef Akzo < Indigo.Systems.Implicit
  %
  ...
  methods
    ...
    function this = Akzo( varargin )
      ...
      num_veil = 0;
      num_invs = 1;
      this = this@Indigo.Systems.Implicit('Akzo', num_eqns, num_veil, num_invs);
    ...
    function out_F = F( this, in_1, in_2, in_3, t )
      ...
      out_6 = K__s * y__1 * y__4_dot + K__s * y__4 * y__1_dot - y__6_dot;
    ...
    function out_JF_x = JF_x( this, in_1, in_2, in_3, t )
      ...
      out_4_3 = out_3_3;
      out_5_3 = out_1_3;
      t46 = K * k__3 * y__1 * y__4;
      t49 = K * k__2 * y__3;
      out_1_4 = t13 * (2 * t46 - t49);
      out_2_4 = 2 * k__3 * y__1 * y__4;
      out_3_4 = k__2 * y__3;
