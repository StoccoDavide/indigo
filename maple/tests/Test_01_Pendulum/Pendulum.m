...
classdef Pendulum < Indigo.Systems.SemiExplicit
  ...
  methods
    ...
    function out_b = b( this, in_1, in_2, t )
      ...
      t3 = g * m;
      out_4 = -2 * lambda * y - t3;
      out_5 = -2 / m * (8 * lambda * u * x + 8 * lambda * v * y + 3 * v * t3);
    ...
    function out_Jb_x = Jb_x( this, in_1, in_2, t )
      ...
      out_4_2 = out_3_1;
      out_5_2 = -16 * t3 * lambda * v;
      out_1_3 = 1;
      out_5_3 = -16 * t3 * lambda * x;
      out_2_4 = 1;
      out_5_4 = -2 * t3 * (3 * g * m + 8 * lambda * y);
      out_3_5 = -2 * x;
      out_4_5 = -2 * y;
      out_5_5 = -2 * t3 * (8 * u * x + 8 * v * y);
