...
%
classdef Indigo_NewtonSolver < handle
  %
  ...
  methods
    ...
    %
    function this = Indigo_NewtonSolver()
    end
    %
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    %
    ...
    function set_tolerance( this, t_tolerance )
      ...
      CMD = 'Indigo_NewtonSolver::set_tolerance(...): ';
    ...
    function set_max_iterations( this, t_max_iterations )
      ...
      CMD = 'Indigo_NewtonSolver::set_max_iterations(...): ';
    ...
    function set_max_function_evaluations( this, t_max_function_evaluations )
      ...
      CMD = 'Indigo_NewtonSolver::set_max_function_evaluations(...): ';
    ...
    function set_max_jacobian_evaluations( this, t_max_jacobian_evaluations )
      ...
      CMD = 'Indigo_NewtonSolver::set_max_jacobian_evaluations(...): ';
    ...
    function set_max_relaxations( this, t_max_relaxations )
      ...
      CMD = 'Indigo_NewtonSolver::set_max_relaxations(...): ';
    ...
    function set_alpha( this, t_alpha )
      ...
      CMD = 'Indigo_NewtonSolver::set_alpha(...): ';
    ...
    function out = eval_function( this, x )
      ...
      CMD = 'Indigo_NewtonSolver::eval_function(...): ';
    ...
    function out = eval_jacobian( this, x )
      ...
      CMD = 'Indigo_NewtonSolver::eval_jacobian(...): ';
