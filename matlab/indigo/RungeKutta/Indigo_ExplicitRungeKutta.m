...
%> \f]
%
classdef Indigo_ExplicitRungeKutta < Indigo_BaseRungeKutta
  %
  methods
    %
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    %
    function this = Indigo_ExplicitRungeKutta( name, order, tbl )
  ...
  methods (Static)
    ...
    function out = check_tableau( tbl )
      ...
      CMD = 'Indigo_ExplicitRungeKutta::check_tableau( tbl ): ';
