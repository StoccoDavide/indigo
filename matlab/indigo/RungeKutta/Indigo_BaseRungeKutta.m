...
%> \f]
%
classdef Indigo_BaseRungeKutta < handle
  %
  ...
  methods
    ...
    %
    function this = Indigo_BaseRungeKutta( t_name, t_order, tbl )

      % Collect input arguments
      this.m_name          = t_name;
      this.m_order         = t_order;
      this.m_newton_solver = Indigo_NewtonSolver();
    ...
    function set_max_substeps( this, t_max_substeps )
      ...
      CMD = 'Indigo_BaseRungeKutta::set_max_substeps(...)';
    ...
    function set_max_projection_iter( this, t_max_projection_iter )
      ...
      CMD = 'Indigo_BaseRungeKutta::set_max_projection_iter(...)';
    ...
    function set_tableau( this, tbl )
      ...
      CMD = 'Indigo_BaseRungeKutta::set_tableau(...): ';
    ...
    function x = project( this, x_tilde, t )
      ...
      CMD = 'Indigo_BaseRungeKutta::project(...): ';
    ...
    function [x_out, x_dot_out, t] = solve( this, t, x_0 )
      ...
      CMD = 'Indigo_BaseRungeKutta::solve(...): ';
      ...
      while (true)
        ...
        if (this.m_progress_bar)
          Indigo_progress_bar(ceil(100*t_s/t(end)))
        end
      ...
      % End progress bar
      if (this.m_progress_bar)
        Indigo_progress_bar(100);
        Indigo_progress_bar(strcat([this.m_name, ' completed!']));
      end
    end
    %
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    function [x_out, x_dot_out, t_out] = solve_adaptive_step( this, t, x_0, varargin )
      ...
      CMD = 'Indigo_BaseRungeKutta::solve_adaptive(...): ';
    ...
    function [x_new, x_dot_new, d_t_star] = advance( this, x_k, x_dot_k, t_k, d_t )
      ...
      CMD = 'Indigo_BaseRungeKutta::advance(...): ';
